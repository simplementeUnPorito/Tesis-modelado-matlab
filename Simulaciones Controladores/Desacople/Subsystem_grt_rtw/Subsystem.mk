...
## Generated on : Fri Jun 19 18:58:16 2026
...
START_DIR                 = C:/Github/Tesis/src/matlab/Simulaciones Controladores/Desacople
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
DEFINES_STANDARD = -DMODEL=Subsystem -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c "$(START_DIR)/Subsystem_grt_rtw/Subsystem.c" "$(START_DIR)/Subsystem_grt_rtw/Subsystem_data.c" "$(START_DIR)/Subsystem_grt_rtw/rt_nonfinite.c"
...
OBJS = rt_logging.obj Subsystem.obj Subsystem_data.obj rt_nonfinite.obj
...
%.obj : $(call SPACE_TO_QUESTION,$(START_DIR))/Subsystem_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(call SPACE_TO_QUESTION,$(START_DIR))/Subsystem_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(call SPACE_TO_QUESTION,$(START_DIR))/Subsystem_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(call SPACE_TO_QUESTION,$(START_DIR))/Subsystem_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(call SPACE_TO_QUESTION,$(START_DIR))/Subsystem_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Subsystem.obj : $(call ESCAPE_SPACES,$(START_DIR))/Subsystem_grt_rtw/Subsystem.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Subsystem_data.obj : $(call ESCAPE_SPACES,$(START_DIR))/Subsystem_grt_rtw/Subsystem_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(call ESCAPE_SPACES,$(START_DIR))/Subsystem_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
